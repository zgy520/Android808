...
import com.tonfun.codecsnetty.bll.protocol.commons.Action;
import com.tonfun.codecsnetty.bll.protocol.commons.ShapeAction;
import com.tonfun.codecsnetty.bll.protocol.commons.transform.AttributeId;
import com.tonfun.codecsnetty.bll.protocol.commons.transform.attribute.*;
import com.tonfun.codecsnetty.bll.protocol.commons.transform.parameter.*;
import com.tonfun.codecsnetty.bll.protocol.t808.*;
...
public class JT808Beans {
    ...
    public static T0102 T0102_2013() {
        T0102 bean = new T0102(); // muofQRoNLS9YoqEW
//        bean.setToken("pmYGzGukO8K4Z5lpIOTg8dqb3eprYaHBbXSPLtdbyG8=");
        bean.setToken(NettyApplication.token);
        return bean;
    }
